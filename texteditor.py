...
class Editor():
    ...
    def file_open(self, event=None, filepath=None):
        ...
        if result != None: #None => Aborted or Save cancelled, False => Discarded, True = Saved or Not modified
            if filepath == None:
                filepath = filedialog.askopenfilename(initialdir = os.getcwd(), filetypes=(('Text files', '*.txt'), ('All files', '*.*')))
    ...
    def file_save_as(self, event=None, filepath=None):
        if filepath == None:
            filepath = filedialog.asksaveasfilename(initialdir = os.getcwd(), filetypes=(('Text files', '*.txt'), ('All files', '*.*'))) #defaultextension='.txt'
        try:
